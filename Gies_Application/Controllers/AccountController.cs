...
namespace TestRole.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		private ApplicationDbContext1 context;
	...
	//	[Authorize(Roles = "Admin")]
		...
		public async Task<ActionResult> Register(RegisterViewModel model)
		{
			if (ModelState.IsValid)
			{
				var user = new ApplicationUser1 { UserName = model.UserName, Email = model.Email };
		...
		public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
		{
			...
			if (ModelState.IsValid)
			{
				...
				var user = new ApplicationUser1 { UserName = model.Email, Email = model.Email };
